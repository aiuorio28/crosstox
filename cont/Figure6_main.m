...
%% parameters varied
gamma=0; % growth inhibition
s=0.85; % extramortality (bifurcation parameter in Fig.6)
psigma=0.9;%bifurcation parameter in Fig.5
...
plotbra('bpt1_d',nfig,cmp,'cl',[1,0.55,0]);
%plotbra('bpt1_u',nfig,cmp,'cl',[1,0.55,0]);
xlabel('s')
ylabel('||R||_{L^1}')
axis([0 0.85 302 347])